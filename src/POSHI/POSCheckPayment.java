...
public class POSCheckPayment extends JPanel {
	 ...
	 */
	public POSCheckPayment(JFrame currentFrame, Store store, Session session, Sale sale, JTextField saleTotal,JTextField AmtTendered,JButton btnPaymentComplete) {
		setLayout(null);
		...
		lblAccountNum.setBounds(12, 103, 80, 16);
		add(lblAccountNum);
		
		textField_4 = new JTextField();
		textField_4.setBounds(114, 100, 116, 22);
		add(textField_4);
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String amt =sale.calcAmount(new BigDecimal(textField_2.getText())).toString();
				Check check = new Check(amt,textField_2.getText(),textField_4.getText(),textField_3.getText(),textField_5.getText());
