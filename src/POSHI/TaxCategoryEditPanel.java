...
public class TaxCategoryEditPanel extends JPanel {
	...
	public TaxCategoryEditPanel(JFrame currentFrame,Store store, TaxCategory taxCat,boolean isAdd) {
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                currentFrame.getContentPane().removeAll();				
				currentFrame.getContentPane().add(new TaxRateEditPanel(currentFrame,store,taxCat,new TaxRate(),isAdd));
				currentFrame.getContentPane().revalidate();
		...
		btnEdit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 currentFrame.getContentPane().removeAll();				
				 currentFrame.getContentPane().add(new TaxRateEditPanel(currentFrame,store,taxCat,list.getSelectedValue(),isAdd));
				 currentFrame.getContentPane().revalidate();
